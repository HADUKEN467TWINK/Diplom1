    ...
    <body>
            ...
            <div class="grid">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Выберите файлы для загрузки. ZIP-архивы с BDU будут автоматически распакованы.</p>
        ...
        <script>
            ...
            async function uploadFiles() {
                ...
                if (loadBdu && !bduFile) {
                    alert('Выбран файл BDU, но он не определен. Пожалуйста, выберите файл BDU (XML или ZIP).');
                    return;
                }

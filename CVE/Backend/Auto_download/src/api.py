    ...
    <div class="container">
        <div class="header">
            ...
            <div class="header-right">
                <button class="btn-settings" onclick="window.open('http://localhost:8002', '_blank')">
